! function () {
    ...
    e.version = "2.1.0", e.utils = {}, e.utils.warn = function (e) {
            return function (t) {
                e.console && console.warn && console.warn(t)
            }
        }(this), e.utils.asString = function (e) {
            return void 0 === e || null === e ? "" : e.toString()
        }, e.FieldRef = function (t, r) {
            this.docRef = t, this.fieldName = r, this._stringValue = r + e.FieldRef.joiner + t
            ...
            for (var r = t.toString().trim().toLowerCase(), i = r.length, n = [], s = 0, o = 0; s <= i; s++) {
                var a = s - o;
                (r.charAt(s).match(e.tokenizer.separator) || s == i) && (a > 0 && n.push(new e.Token(r.slice(o, s), {
                    position: [o, a],
                    index: n.length
                })), o = s + 1)
            }
            ...
            for (var t = this._stack.length, r = 0; r < t; r++) {
                var i = this._stack[r];
                e = e.reduce(function (t, r, n) {
                    var s = i(r, n, e);
                    return void 0 === s || "" === s ? t : t.concat(s)
                }, [])
            }
            return e
        }, e.Pipeline.prototype.runString = function (t) {
            var r = new e.Token(t);
            ...
            var e = {
                ...
                r = "[aeiouy]",
                i = "[^aeiou][^aeiouy]*",
                n = new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*"),
                ...
                T = function (r) {
                    ...
                    if ("y" == (S = r.substr(0, 1)) && (r = S.toUpperCase() + r.substr(1)), P = u, b = l, P.test(r) ? r = r.replace(P, "$1$2") : b.test(r) && (r = r.replace(b, "$1$2")), P = d, b = h, P.test(r)) {
                        var F = P.exec(r);
                        (P = n).test(F[1]) && (P = c, r = r.replace(P, ""))
                    } else b.test(r) && (i = (F = b.exec(r))[1], (b = a).test(i) && (r = i, E = p, I = y, (b = f).test(r) ? r += "e" : E.test(r) ? (P = c, r = r.replace(P, "")) : I.test(r) && (r += "e")));
                    return (P = m).test(r) && (r = (i = (F = P.exec(r))[1]) + "i"), (P = g).test(r) && (i = (F = P.exec(r))[1], T = F[2], (P = n).test(i) && (r = i + e[T])), (P = x).test(r) && (i = (F = P.exec(r))[1], T = F[2], (P = n).test(i) && (r = i + t[T])), P = v, b = w, P.test(r) ? (i = (F = P.exec(r))[1], (P = s).test(i) && (r = i)) : b.test(r) && (i = (F = b.exec(r))[1] + F[2], (b = s).test(i) && (r = i)), (P = k).test(r) && (i = (F = P.exec(r))[1], b = o, E = L, ((P = s).test(i) || b.test(i) && !E.test(i)) && (r = i)), P = Q, b = s, P.test(r) && b.test(r) && (P = c, r = r.replace(P, "")), "y" == S && (r = S.toLowerCase() + r.substr(1)), r
                };
            return function (e) {
                return e.update(T)
            }
            ...
            for (var i = new e.TokenSet, n = [{
                ...
                if (s.str.length > 0) {
                    var o;
                    (u = s.str.charAt(0)) in s.node.edges ? o = s.node.edges[u] : (o = new e.TokenSet, s.node.edges[u] = o), 1 == s.str.length ? o.final = !0 : n.push({
                        node: o,
                ...
                if (s.editsRemaining > 0 && s.str.length > 1) {
                    var a, u = s.str.charAt(1);
                    u in s.node.edges ? a = s.node.edges[u] : (a = new e.TokenSet, s.node.edges[u] = a), s.str.length <= 2 ? a.final = !0 : n.push({
                        node: a,
                ...
                if (s.editsRemaining > 0 && 1 == s.str.length && (s.node.final = !0), s.editsRemaining > 0 && s.str.length >= 1) {
                    if ("*" in s.node.edges) l = s.node.edges["*"];
                    else {
                ...
                if (s.editsRemaining > 0) {
                    if ("*" in s.node.edges) d = s.node.edges["*"];
                    else {
                        var d = new e.TokenSet;
                        s.node.edges["*"] = d
                    }
                    0 == s.str.length ? d.final = !0 : n.push({
                        node: d,
                        editsRemaining: s.editsRemaining - 1,
                        str: s.str
                    })
                ...
                if (s.editsRemaining > 0 && s.str.length > 1) {
                    var h, c = s.str.charAt(0),
                        f = s.str.charAt(1);
                    f in s.node.edges ? h = s.node.edges[f] : (h = new e.TokenSet, s.node.edges[f] = h), 1 == s.str.length ? h.final = !0 : n.push({
                        node: h,
                        editsRemaining: s.editsRemaining - 1,
                        str: c + s.str.slice(2)
                    })
            ...
            for (var r = new e.TokenSet, i = r, n = !1, s = 0, o = t.length; s < o; s++) {
                var a = t[s],
                    u = s == o - 1;
                if ("*" == a) n = !0, r.edges[a] = r, r.final = u;
                else {
                    var l = new e.TokenSet;
                    l.final = u, r.edges[a] = l, r = l, n && (r.edges["*"] = i)
                }
            }
            return i
            ...
            for (var r = new e.TokenSet, i = void 0, n = [{
                ...
                for (var s = Object.keys(i.qNode.edges), o = s.length, a = Object.keys(i.node.edges), u = a.length, l = 0; l < o; l++)
                    for (var d = s[l], h = 0; h < u; h++) {
                        var c = a[h];
                        if (c == d || "*" == d) {
                            var f = i.node.edges[c],
                                p = i.qNode.edges[d],
                                y = f.final && p.final,
                                m = void 0;
                            c in i.output.edges ? (m = i.output.edges[c]).final = m.final || y : ((m = new e.TokenSet).final = y, i.output.edges[c] = m), n.push({
                                qNode: p,
                                output: m,
                                node: f
                            })
            ...
            for (n = 0; n < t.length && n < this.previousWord.length && t[n] == this.previousWord[n]; n++) i++;
            ...
            t.call(r, r);
            for (P = 0; P < r.clauses.length; P++) {
                var s = r.clauses[P],
                    o = null;
                o = s.usePipeline ? this.pipeline.runString(s.term) : [s.term];
                for (var a = 0; a < o.length; a++) {
                    var u = o[a];
                    s.term = u;
                    for (var l = e.TokenSet.fromClause(s), d = this.tokenSet.intersect(l).toArray(), h = 0; h < d.length; h++)
                        for (var c = d[h], f = this.invertedIndex[c], p = f._index, y = 0; y < s.fields.length; y++) {
                            var m = s.fields[y],
                                g = f[m],
                                x = Object.keys(g);
                            m in n || (n[m] = new e.Vector), n[m].upsert(p, 1 * s.boost, function (e, t) {
                                return e + t
                            });
                            for (var v = 0; v < x.length; v++) {
                                var w, k, Q = x[v],
                                    L = new e.FieldRef(Q, m);
                                w = g[Q], k = new e.MatchData(c, m, w), L in i ? i[L].combine(k) : i[L] = k
                            }
                        }
                }
            }
            for (var T = Object.keys(i), S = {}, P = 0; P < T.length; P++) {
                var b = e.FieldRef.fromString(T[P]),
                    E = b.docRef,
                    I = this.fieldVectors[b],
                    F = n[b.fieldName].similarity(I);
                E in S ? (S[E].score += F, S[E].matchData.combine(i[b])) : S[E] = {
                    ref: E,
                    score: F,
                    matchData: i[b]
                }
            ...
            this._ref = "id", this._fields = [], this.invertedIndex = Object.create(null), this.fieldTermFrequencies = {}, this.fieldLengths = {}, this.tokenizer = e.tokenizer, this.pipeline = new e.Pipeline, this.searchPipeline = new e.Pipeline, this.documentCount = 0, this._b = .75, this._k1 = 1.2, this.termIndex = 0, this.metadataWhitelist = []
        }, e.Builder.prototype.ref = function (e) {
            this._ref = e
        }, e.Builder.prototype.field = function (e) {
            this._fields.push(e)
        }, e.Builder.prototype.b = function (e) {
            this._b = e < 0 ? 0 : e > 1 ? 1 : e
        }, e.Builder.prototype.k1 = function (e) {
            this._k1 = e
        }, e.Builder.prototype.add = function (t) {
            var r = t[this._ref];
            ...
            for (var i = 0; i < this._fields.length; i++) {
                var n = this._fields[i],
                    ...
                    u = new e.FieldRef(r, n),
                    l = {};
                this.fieldTermFrequencies[u] = l, this.fieldLengths[u] = 0, this.fieldLengths[u] += a.length;
                for (var d = 0; d < a.length; d++) {
                    var h = a[d];
                    if (void 0 == l[h] && (l[h] = 0), l[h] += 1, void 0 == this.invertedIndex[h]) {
                        var c = Object.create(null);
                        c._index = this.termIndex, this.termIndex += 1;
                        for (var f = 0; f < this._fields.length; f++) c[this._fields[f]] = Object.create(null);
                        this.invertedIndex[h] = c
                    }
                    void 0 == this.invertedIndex[h][n][r] && (this.invertedIndex[h][n][r] = Object.create(null));
                    for (var p = 0; p < this.metadataWhitelist.length; p++) {
                        var y = this.metadataWhitelist[p],
                            m = h.metadata[y];
                        void 0 == this.invertedIndex[h][n][r][y] && (this.invertedIndex[h][n][r][y] = []), this.invertedIndex[h][n][r][y].push(m)
                    }
                }
            }
            ...
            for (var t = Object.keys(this.fieldLengths), r = t.length, i = {}, n = {}, s = 0; s < r; s++) {
                ...
                n[a = o.fieldName] || (n[a] = 0), n[a] += 1, i[a] || (i[a] = 0), i[a] += this.fieldLengths[o]
            }
            for (s = 0; s < this._fields.length; s++) {
                var a = this._fields[s];
                i[a] = i[a] / n[a]
            }
            this.averageFieldLength = i
        }, e.Builder.prototype.createFieldVectors = function () {
            for (var t = {}, r = Object.keys(this.fieldTermFrequencies), i = r.length, n = 0; n < i; n++) {
                for (var s = e.FieldRef.fromString(r[n]), o = s.fieldName, a = this.fieldLengths[s], u = new e.Vector, l = this.fieldTermFrequencies[s], d = Object.keys(l), h = d.length, c = 0; c < h; c++) {
                    var f = d[c],
                        p = l[f],
                        y = this.invertedIndex[f]._index,
                        m = e.idf(this.invertedIndex[f], this.documentCount) * ((this._k1 + 1) * p) / (this._k1 * (1 - this._b + this._b * (a / this.averageFieldLength[o])) + p),
            ...
            this.metadata = {}, this.metadata[e] = {}, this.metadata[e][t] = r
        ...
        }, e.Query.wildcard = new String("*"), e.Query.wildcard.NONE = 0, e.Query.wildcard.LEADING = 1, e.Query.wildcard.TRAILING = 2, e.Query.prototype.clause = function (t) {
            return "fields" in t || (t.fields = this.allFields), "boost" in t || (t.boost = 1), "usePipeline" in t || (t.usePipeline = !0), "wildcard" in t || (t.wildcard = e.Query.wildcard.NONE), t.wildcard & e.Query.wildcard.LEADING && t.term.charAt(0) != e.Query.wildcard && (t.term = "*" + t.term), t.wildcard & e.Query.wildcard.TRAILING && t.term.slice(-1) != e.Query.wildcard && (t.term = t.term + "*"), this.clauses.push(t), this
        }, e.Query.prototype.term = function (e, t) {
            var r = t || {};
            ...
            var t, r;
            do {
                r = (t = this.next()).charCodeAt(0)
            } while (r > 47 && r < 58);
            t != e.QueryLexer.EOS && this.backup()
        }, e.QueryLexer.prototype.more = function () {
            return this.pos < this.length
        }, e.QueryLexer.EOS = "EOS", e.QueryLexer.FIELD = "FIELD", e.QueryLexer.TERM = "TERM", e.QueryLexer.EDIT_DISTANCE = "EDIT_DISTANCE", e.QueryLexer.BOOST = "BOOST", e.QueryLexer.lexField = function (t) {
            ...
            for (var t = e.QueryParser.parseFieldOrTerm; t;) t = t(this);
            return this.query
        ...
        }, e.QueryParser.parseFieldOrTerm = function (t) {
            var r = t.peekLexeme();
            ...
            if (void 0 != r) {
                ...
                if (isNaN(i)) {
                    s = "edit distance must be numeric";
                    throw new e.QueryParseError(s, r.start, r.end)
                }
                ...
                if (void 0 != n) switch (n.type) {
                    ...
                    default:
                        ...
                        throw new e.QueryParseError(s, n.start, n.end)
                } else t.nextClause()
            }
        ...
        function (t, r) {
            "function" == typeof define && define.amd ? define(r) : "object" == typeof exports ? module.exports = e : t.lunr = e
        }(this, function () {
            return e
        })
}();